        ...
        <Form {...formItemLayout} >
          ...
          <Col span={12}>
            <Form.Item label="排产时间">
              <TimePicker minuteStep={5} format="HH:mm" value={productionStartTime?moment(productionStartTime, "HH:mm"):null} 
              onChange={(d)=>this.setState({productionStartTime: d?moment(d).format("HH:mm"):null})}
              />
              <span className="timeline">-</span>
              <TimePicker minuteStep={5} format="HH:mm" value={productionEndTime?moment(productionEndTime, "HH:mm"):null} 
              onChange={(d)=>this.setState({productionEndTime: d?moment(d).format("HH:mm"):null})}/>
            </Form.Item>
            <Form.Item label="扣除中饭时间">
              <TimePicker minuteStep={5} format="HH:mm" value={cutOneStartTime?moment(cutOneStartTime, "HH:mm"):null} 
                onChange={(d)=>this.setState({cutOneStartTime: d?moment(d).format("HH:mm"):null})}
                />
                <span className="timeline">-</span>
                <TimePicker minuteStep={5} format="HH:mm" value={cutOneEndTime?moment(cutOneEndTime, "HH:mm"):null} 
