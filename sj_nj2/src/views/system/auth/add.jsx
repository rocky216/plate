...
import {getTreeRole, addRole} from "@/actions/systemAction"
import {addAuthColumns} from "../columns"


class AddSystemAuth extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      treeData: [],
  ...
  componentDidMount(){
    this.props.actions.getTreeRole({}, res=>{
      _.each(res, item=>{
  ...
  render(){
    ...
    const {treeData, selectAll} = this.state
...
function mapDispatchProps(dispatch){
  return {
    actions: bindActionCreators({getTreeRole, addRole}, dispatch)
  }
}
...
export default connect(mapStateProps, mapDispatchProps)(Form.create()(AddSystemAuth))