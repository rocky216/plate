...
class _DisHallDetailPageState extends State<DisHallDetailPage> {
  ...
  getDetail() async {
    var data = await NetHttp.getRequest("/api/app/owner/theme/info", context: context, params: {
  ...
  handlenSubmit() async {
    ...
    var data = await NetHttp.post("/api/app/owner/theme/startVoteTheme", context: context, params: houses);
    if(data != null){
      showToast("投票成功！");
      this.getDetail();
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyHeader(title: Text("议事堂详情"),),
      body: MyScrollView(
        child: Column(
          children: <Widget>[
            Container(
