...
import {getAccount, addOtherOrder} from "@/actions/otherAction"
  ...
  handlenSubmit(){
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        values
        this.props.actions.addOtherOrder({
          ...values,
          objectId,
          ownersId,
      ...
      <JCard spinning={spinning}>
        <Card title="新增其他缴费订单" extra={(
          <div>
            ...
            <Link to="/workcenter/otherfee" className="mgl10"><Button><Icon type="rollback" />返回</Button></Link>
          </div>
        )}>
          <Form {...formItemLayout} >
...
function mapDispatchProps(dispatch){
  return {
    actions: bindActionCreators({getAccount, addOtherOrder}, dispatch)
  }
}
