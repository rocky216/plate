...
class ClassHouse extends React.Component {
  render(){
    ...
    return (
      <Form layout="inline">
        ...
        <Form.Item label="实际楼层">
          <Text mark>{data.trueLevel}层</Text>
        </Form.Item>
        <Form.Item label="楼层">
          <Text mark>{data.level}层</Text>
        </Form.Item>
        <Form.Item>
...
export default connect(mapStateProps, mapDispatchProps)(ClassHouse)