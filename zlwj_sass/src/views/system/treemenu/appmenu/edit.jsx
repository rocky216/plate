...
import {editAppTreeMenuList, getAppTreeMenuList} from "@/actions/systemAction"
...
class EditMenu extends React.Component {
  handlenSubmit(){
    this.props.form.validateFieldsAndScroll((err, values)=>{
      if(!err){
        this.props.actions.editAppTreeMenuList({
          ...values,
...
function mapDispatchProps(dispatch){
  return {
    actions: bindActionCreators({editAppTreeMenuList, getAppTreeMenuList}, dispatch)
  }
}
